...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
    		"date_day 235 136 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"   # Day of week
		"date 235 136 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"      # Date
		"time 235 136 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"      # Time
		"weather 37 255 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"    # Weather
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		"battery 137 127 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"   # Battery
		"now_playing 234 37 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" # Spotify
		"pwd 89 211 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"        # Current working directory
	)
fi
